...
if(isset($_POST['submit']))
  ...
  $eid=$_GET['editid'];
    ...
    $query=mysqli_query($con, "update tblcategory set VehicleCat='$catname', tollfee= $tollfee where ID='$eid'");
    if ($query) {
...
?>              
									...
									<div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Fee/Toll Amount</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="tollfee" name="tollfee" class="form-control" placeholder="Fee/Toll Amount" required="true" value="<?php  echo $row['tollfee'];?>"></div>
                                    </div>
