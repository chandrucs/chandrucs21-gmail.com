...
if(isset($_POST['submit']))
  {
	...
	$query1=mysqli_query($con,"select * from tblcategory where VehicleCat='$catename'");
              while($row=mysqli_fetch_array($query1))
              {$tollcharge= $row['tollfee'];
	...
	$l=$_POST['accountnumber'];
  $m=$_POST['bankname']; 
  $n=$_POST['ifsccode']; 
  $o=300;
    
     
    $query=mysqli_query($con, "insert into  tblvehicle(RFIDNumber,VehicleCategory,VehicleCompanyname,RegistrationNumber,OwnerName,OwnerContactNumber, TollCharge,accountnumber,bankname,ifsccode,balance ) value('$rfid','$catename','$vehcomp','$vehreno','$ownername','$ownercontno','$tollcharge',$l,'$m','$n',$o)");
    if ($query) {
    ...
    echo $msg;
              ...
              ?>    
                  ...
                  <?php } ?> 
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">RFID Number</label></div>
                                        <div class="col-12 col-md-9"><input type="number" id="rfid" name="rfid" class="form-control" placeholder="RFID Number" required="true"></div>
                                    </div>
									 <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">ACC Number</label></div>
                                        <div class="col-12 col-md-9"><input type="number" id="accountnumber" name="accountnumber" class="form-control" placeholder="ACC Number" required="true"></div>
                                    </div>
									 <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Bank Name</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="bankname" name="bankname" class="form-control" placeholder="Bank Name" required="true"></div>
                                    </div>
									 <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">IFSC Code</label></div>
                                        <div class="col-12 col-md-9"><input type="number" id="ifsccode" name="ifsccode" class="form-control" placeholder="IFSC Code" required="true"></div>
                                    </div>
