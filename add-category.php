...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into  tblcategory(VehicleCat, tollfee) value('$catname',$tollfee)");
    if ($query) {
   ...
   <?php include_once('includes/header.php');?>
    ...
    echo $msg;
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Toll Fee</label></div>

										<div class="col-12 col-md-9"><input type="number" id="tollfee" name="tollfee" class="form-control" placeholder="toll fee" required="true"></div>
