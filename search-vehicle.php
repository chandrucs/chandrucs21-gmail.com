...
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal" name="search">
    ...
    echo $msg;
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Search By RFID Number</label></div>
...
$sdata=$_POST['searchdata'];
  ...
  <h4 align="center">Result against "<?php echo $sdata;?>" keyword </h4> 
               ...
               <?php
$ret=mysqli_query($con,"select *from   tblvehicle where RFIDNumber like '$sdata%'");
